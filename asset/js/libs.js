...
! function(t, e) {
      ...
      return void 0 === s && (s = 200), le.all(W(t).map(function(r) {
          return new le(function(e, n) {
              ...
              te(r, "animationend animationcanceled", function(t) {
                  ...
                  self: !0
              }), qe(r, "animationDuration", s + "ms"), Be(r, o, tn + (u ? "leave" : "enter")), g(o, tn) && (a && Be(r, "uk-transform-origin-" + a), u && Be(r, tn + "reverse"))
          })
      }))
  }
  ...
  function an(n, i) {
      ...
      for (t in on)
          for (var s in on[t]) r[on[t][s]] += o[t];
      if (!i) return r;
      var a = qe(n, "position");
  ...
  function un(t) {
      ...
      return _(a) && (n -= (r = an(a)).top + L(qe(a, "borderTopWidth")), i -= r.left + L(qe(a, "borderLeftWidth"))), {
  ...
  function fn(n, t, e) {
      return void 0 === e && (e = "border-box"), qe(n, "boxSizing") === e ? on[t].map(p).reduce(function(t, e) {
  ...
  function xn(t) {
      vn.scheduled || (vn.scheduled = !0, t && t < bn ? le.resolve().then(function() {
          return wn(t)
  ...
  function Cn(e, n, i) {
      var t, r, o = {};
      if ((n = k(n) ? n.options : n).extends && (e = Cn(e, n.extends, i)), n.mixins)
          for (var s = 0, a = n.mixins.length; s < a; s++) e = Cn(e, n.mixins[s], i);
      for (t in e) u(t);
  ...
  Sn.events = Sn.created = Sn.beforeConnect = Sn.connected = Sn.beforeDisconnect = Sn.disconnected = Sn.destroy = En, Sn.args = function(t, e) {
      return !1 !== e && En(e || t)
  ...
  function Wn(t, r, o) {
      return void 0 === r && (r = 0), void 0 === o && (o = 0), !!$t(t) && tt.apply(void 0, Un(t).map(function(t) {
          var e = an(Yn(t)),
              n = e.top,
              i = e.left,
              t = e.bottom,
  ...
  function Rn(s, t) {
      ...
      return u.reduce(function(t, e, n) {
          ...
          return r < o ? (c = o - r, o = r) : c = 0,
              function() {
                  return s = e, a = o - i, new le(function(n) {
                      var t, i = s.scrollTop,
  ...
  function Jn(t, e, h, l, d, n, i, r) {
      ...
      var o, p = an(t),
          m = an(e),
          g = m;
      return Zn(g, h, p, -1), Zn(g, l, m, 1), d = ti(d, p.width, p.height), n = ti(n, m.width, m.height), d.x += n.x, d.y += n.y, g.left += d.x, g.top += d.y, i && (o = Un(t).map(Yn), r && !w(o, r) && o.unshift(r), o = o.map(function(t) {
          return an(t)
      }), X(Kn, function(t, s) {
          var a = t[0],
              u = t[1],
  ...
  var ii, ri, oi, si, ai, ui, ci, hi, li, di = rt(function(t) {
  ...
  ni.util = ei, ni.data = "__uikit__", ni.prefix = "uk-", ni.options = {}, ni.version = "3.7.6", oi = (ii = ni).data, ii.use = function(t) {
          ...
          var e = this;
          void 0 === t && (t = "update"), this._connected && ("update" !== t && "resize" !== t || this._callWatches(), this.$options.update && (this._updates || (this._updates = new Set, vn.read(function() {
              e._connected && ! function(i) {
                  for (var r = this, o = this.$options.update, t = 0; t < o.length; t++) ! function(t) {
                      ...
                      (i.has("update") || e && e.some(function(t) {
                          return i.has(t)
                      })) && (e = void 0, t && (e = t.call(r, r._data, i)) && I(e) && Y(r._data, e), n && !1 !== e && vn.write(function() {
          ...
          var t, e = this;
          this._watch || (t = !c(this, "_watch"), this._watch = vn.read(function() {
      ...
      }, ui = 0, (ai = ni).prototype._init = function(t) {
          (t = t || {}).data = function(t, e) {
              ...
              return n
          }(t, this.constructor.options), this.$options = Cn(this.constructor.options, t, this), this.$el = null, this.$props = {}, this._uid = ui++, this._initData(), this._initMethods(), this._initComputeds(), this._callHook("created"), t.el && this.$mount(t.el)
      ...
      }, hi = (ci = ni).data, li = {}, ci.component = function(s, t) {
          var e = d(s);
          ...
          return n.name = s, n.install && n.install(ci, n, s), ci._initialized && !n.functional && vn.read(function() {
              ...
              toggleElement: function(e, s, a) {
                  ...
                  return new le(function(t) {
                      return le.all(W(e).map(function(t) {
                          ...
                          var o, n = (k(a) ? a : !1 !== a && u.hasAnimation ? u.hasTransition ? bi(u) : (o = u, function(t, e) {
                                  rn.cancel(t);
                                  var n = o.animation,
                                      i = o.duration,
                                      r = o._toggle;
  ...
  function bi(t) {
      ...
      return function(t, e) {
          ...
          i = hn(t) + (n ? 0 : i);
          return hn(t, r), (e ? Qe.start(t, Y({}, a, {
              overflow: "hidden",
              height: i
          }), Math.round(s * (1 - r / i)), c) : Qe.start(t, u, Math.round(s * (r / i)), c).then(function() {
              return h(t, !1)
          })).then(function() {
              return qe(t, a)
          })
          ...
          toggle: function(t, r) {
              ...
              this.multiple || w(t, e[0]) || (e = e.concat(t)), !this.collapsible && t.length < 2 && !_t(e, ":not(." + this.clsOpen + ")").length || e.forEach(function(t) {
                  return o.toggleElement(t, !Le(t, o.clsOpen), function(e, n) {
                      ...
                      if (!1 !== r && o.hasTransition) return e._wrapper || (e._wrapper = Ie(i, "<div" + (n ? " hidden" : "") + ">")), yi(i, !1), bi(o)(e._wrapper, n).then(function() {
                          var t;
                          yi(i, !n), delete e._wrapper, Te(i), n && (Wn(t = Ne(o.$props.toggle, e)) || Rn(t, {
                              offset: o.offset
                          }))
                      });
                      yi(i, !n)
  ...
  var Ii, Ei = {
      ...
      Ti = {
          ...
          methods: {
              positionAt: function(t, e, n) {
                  ...
                  r = Jn(t, e, "x" === o ? pn(this.dir) + " " + this.align : this.align + " " + pn(this.dir), "x" === o ? this.dir + " " + this.align : this.align + " " + this.dir, "x" === o ? "" + ("left" === this.dir ? -r : r) : " " + ("top" === this.dir ? -r : r), null, this.flip, n).target, n = r.x, r = r.y;
      ...
      Ci = {
          ...
          events: [{
              ...
              handler: function() {
                  var r = this;
                  (Ii = this).tracker.init(), te(this.$el, "hide", Zt(document, mt, function(t) {
                      var i = t.target;
                  ...
                  return {
                      ...
                      columns: function(t) {
                          for (var e = [], n = 0; n < t.length; n++)
                              for (var i = zi(t[n], "left", "right"), r = 0; r < i.length; r++) e[r] = e[r] ? e[r].concat(i[r]) : i[r];
  ...
  var Bi = {
      ...
      update: [{
          ...
          read: function(t) {
              t = t.height;
              return !Oi(this.$el) && {
                  scrolled: !!this.parallax && qn(this.$el, t ? t - hn(this.$el) : 0) * Math.abs(this.parallax)
              }
          },
          write: function(t) {
              var e = t.columns,
  ...
  var Pi = ht ? {
      ...
      Hi = {
          ...
          update: {
              read: function() {
                  return {
                      rows: (this.row ? Ni(this.elements) : [this.elements]).map(Li)
                  }
              },
              write: function(t) {
  ...
  function Li(t) {
      ...
      return e && r && (qe(t, "minHeight", ""), n = t.map(Fi), i = Math.max.apply(Math, n)), {
  ...
  var rr = {
      ...
      connected: function() {
          window.IntersectionObserver ? (fr[this.cacheKey] ? or(this.$el, fr[this.cacheKey], this.dataSrcset, this.sizes) : this.isImg && this.width && this.height && or(this.$el, function(t, e, n) {
              n && (n = nt.ratio({
                  width: t,
                  height: e
              }, "width", mn(ar(n))), t = n.width, e = n.height);
              return 'data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="' + t + '" height="' + e + '"></svg>'
          }(this.width, this.height, this.sizes)), this.observer = new IntersectionObserver(this.load, {
              rootMargin: this.offsetTop + "px " + this.offsetLeft + "px"
          }), requestAnimationFrame(this.observe)) : or(this.$el, this.dataSrc, this.dataSrcset, this.sizes)
      },
      disconnected: function() {
      ...
      update: {
          ...
          write: function(t) {
              var e, n, i;
              this.dataSrcset && 1 !== window.devicePixelRatio && (!(n = qe(this.$el, "backgroundSize")).match(/^(auto\s?)+$/) && L(n) !== t.bgSize || (t.bgSize = (e = this.dataSrcset, n = this.sizes, i = mn(ar(n)), (e = (e.match(hr) || []).map(L).sort(function(t, e) {
                  return t - e
              })).filter(function(t) {
                  return i <= t
  ...
  function ar(t) {
      ...
      for (sr.lastIndex = 0; e = sr.exec(t);)
          if (!e[1] || window.matchMedia(e[1]).matches) {
              e = g(n = e[2], "calc") ? n.slice(5, -1).replace(ur, function(t) {
                  return mn(t)
              }).replace(/ /g, "").match(cr).reduce(function(t, e) {
                  return t + +e
              }, 0) : n;
              break
          } return e || "100vw"
  ...
  var gr = {
      ...
      wr = {
          ...
          events: [{
              ...
              self: !0,
              handler: function(t, e) {
                  t.defaultPrevented || (t.preventDefault(), this.target = e.$el, this.isToggled() === w(vr, this) && this.toggle())
              }
          }, {
              name: "beforeshow",
              self: !0,
              handler: function(t) {
                  ...
                  !this.stack && vr.length ? (le.all(vr.map(function(t) {
                      return t.hide()
                  })).then(this.show), t.preventDefault()) : vr.push(this)
              }
          }, {
              name: "show",
              self: !0,
              handler: function() {
                  ...
                  ln(window) > t.clientWidth && this.overlay && qe(document.body, "overflowY", "scroll"), this.stack && qe(this.$el, "zIndex", L(qe(this.$el, "zIndex")) + vr.length), Be(t, this.clsPage), this.bgClose && te(this.$el, "hide", Zt(document, mt, function(t) {
                      var i = t.target;
                      G(vr) !== r || r.overlay && !Bt(i, r.$el) || Bt(i, r.panel) || te(document, vt + " " + xt + " scroll", function(t) {
                          var e = t.defaultPrevented,
                              n = t.type,
                              t = t.target;
                          e || n !== vt || i !== t || r.hide()
              ...
              self: !0,
              handler: function() {
                  Tt(this.$el) || ot(this.$el, "tabindex", "0"), Ne(":focus", this.$el) || this.$el.focus()
              }
          }, {
              name: "hide",
              self: !0,
              handler: function() {
                  Tt(this.target) && (this.target.focus(), this.target = null)
              }
          }, {
              name: "hidden",
              self: !0,
              handler: function() {
                  var e = this;
                  w(vr, this) && vr.splice(vr.indexOf(this), 1), vr.length || qe(document.body, "overflowY", ""), qe(this.$el, "zIndex", ""), vr.some(function(t) {
      ...
      events: [{
          ...
          handler: function(t) {
              var e = t.current,
                  n = t.keyCode,
                  i = this.getActive();
              n === $r.DOWN && st(e, "aria-expanded") && (t.preventDefault(), i && i.target === e ? kr(i.$el) : (e.click(), te(this.dropContainer, "show", function(t) {
                  return kr(t.target)
              }))), yr(t, this.toggles, i)
          }
      }, {
          ...
          handler: function(t) {
              ...
              w(this.dropdowns, i) && (e = this.getActive(), i = x(n = ze(Et, i), function(t) {
                  return Nt(t, ":focus")
              }), r === $r.UP && (t.preventDefault(), 0 < i && n[i - 1].focus()), r === $r.DOWN && (t.preventDefault(), i < n.length - 1 && n[i + 1].focus()), r === $r.ESC && e && e.target && e.target.focus(), yr(t, this.toggles, e))
          }
      }, {
          name: "mouseleave",
          el: function() {
      ...
      methods: {
          ...
          transitionTo: function(t, e) {
              var n = this,
                  i = this.dropbar,
                  r = $t(i) ? hn(i) : 0;
              return qe(e = r < t && e, "clip", "rect(0," + e.offsetWidth + "px," + r + "px,0)"), hn(i, r), Qe.cancel([e, i]), le.all([Qe.start(i, {
                  height: t
  ...
  var $r = {
      ...
      t = {
          ...
          events: [{
              ...
              handler: function() {
                  var t;
                  this.clsContainerAnimation && ((t = Sr()).content = t.content.replace(/,user-scalable=0$/, "")), "reveal" === this.mode && Te(this.panel), Oe(this.panel, this.clsSidebarAnimation, this.clsMode), Oe(this.$el, this.clsOverlay), qe(this.$el, "display", ""), Oe(document.body, this.clsContainer, this.clsFlip), qe(document.documentElement, "overflowY", "")
              }
          }, {
  ...
  var dt = {
          ...
          update: {
              read: function() {
                  return !!(this.content && this.container && $t(this.$el)) && {
                      ...
                      max: Math.max(this.minHeight, hn(this.container) - (sn(this.content).height - hn(this.$el)))
                  }
              },
              write: function(t) {
                  var e = t.current,
      ...
      ft = {
          ...
          methods: {
              scrollTo: function(t) {
                  var e = this;
                  t = t && Ne(t) || document.body, ee(this.$el, "beforescroll", [this, t]) && Rn(t, {
                      offset: this.offset
                  }).then(function() {
          ...
          update: [{
              read: function(t) {
                  ...
                  this.elements.forEach(function(t) {
                      ...
                      }), t[Ir].show = Wn(t, e.offsetTop, e.offsetLeft)
                  })
              },
              write: function(n) {
                  var i = this;
      ...
      ei = {
          ...
          events: [{
              ...
              handler: function() {
                  var i, r = this;
                  !1 !== this.targetOffset && location.hash && 0 < window.pageYOffset && ((i = Ne(location.hash)) && vn.read(function() {
                      var t = an(i).top,
                          e = an(r.$el).top,
                          n = r.$el.offsetHeight;
          ...
          update: [{
              read: function(t, e) {
                  ...
                  this.isActive && e.has("resize") && (this.hide(), t = this.$el.offsetHeight, this.show()), t = this.isActive ? t : this.$el.offsetHeight, this.topOffset = an(this.isFixed ? this.placeholder : this.$el).top, this.bottomOffset = this.topOffset + t;
                  e = Er("bottom", this);
                  return this.top = Math.max(L(Er("top", this)), this.topOffset) - this.offset, this.bottom = e && e - this.$el.offsetHeight, this.width = sn($t(this.widthElement) ? this.widthElement : this.$el).width, {
                      height: t,
              ...
              write: function(t, e) {
                  ...
                  (t.lastScroll = c) < 0 || c === u && r || this.showOnUp && !r && !this.isFixed || ((300 < i - o || s !== a) && (t.initScroll = c, t.initTimestamp = i), t.lastDir = s, this.showOnUp && !this.isFixed && Math.abs(t.initScroll - c) <= 30 && Math.abs(u - c) <= 10 || (this.inactive || c < this.top || this.showOnUp && (c <= this.top || "down" === s && r || "up" === s && !this.isFixed && c <= this.bottomOffset) ? this.isFixed ? (this.isFixed = !1, this.animation && c > this.topOffset ? (rn.cancel(this.$el), rn.out(this.$el, this.animation).then(function() {
                      return n.hide()
                  }, Q)) : this.hide()) : rn.inProgress(this.$el) && c < e && (rn.cancel(this.$el), this.hide()) : this.isFixed ? this.update() : this.animation ? (rn.cancel(this.$el), this.show(), rn.in(this.$el, this.animation).catch(Q)) : this.show()))
              },
              events: ["resize", "scroll"]
          }],
          methods: {
              ...
              update: function() {
                  ...
                  D(this.bottom) && this.scroll > this.bottom - this.offset && (e = this.bottom - this.scroll), qe(this.$el, {
                      position: "fixed",
                      top: e + "px",
                      width: this.width
  ...
  }), Cr = (Tr = ni).connect, _r = Tr.disconnect, ct && window.MutationObserver && vn.read(function() {
      document.body && Me(document.body, Cr), new MutationObserver(function(t) {
          return t.forEach(Ar)
      }).observe(document, {
          childList: !0,
          subtree: !0
  ...
  function Dr(t, s, a, u) {
      ...
      var c = Br(s, !0),
          ...
          n = e(function() {
              return Be(s, Nr), le.all(Pr(s).map(function(e, n) {
                  return new le(function(t) {
  ...
  function Or(t) {
      return le.all(Pt(t).filter(Qe.inProgress).map(function(e) {
          return new le(function(t) {
  ...
  function Hr(t, d, f) {
      return new le(function(l) {
          return requestAnimationFrame(function() {
              ...
              Qe.cancel(d), u.forEach(Qe.cancel), Fr(d), t(), u = u.concat(Pt(d).filter(function(t) {
                  return !w(u, t)
              })), le.resolve().then(function() {
                  vn.flush();
                  var n, i, r, t, e, o = qe(d, ["height", "padding"]),
                      e = (n = d, r = c, t = (i = u).map(function(t, e) {
                          return !!(Ct(t) && e in r) && (r[e] ? $t(t) ? jr(t) : {
                              opacity: 0
                          } : {
                              opacity: $t(t) ? 1 : 0
                          })
  ...
  Pi = {
      ...
      methods: {
          animate: function(t, e) {
              ...
              return ("fade" === i ? Dr : "delayed-fade" === i ? function() {
                  for (var t = [], e = arguments.length; e--;) t[e] = arguments[e];
              ...
              Transitioner: function(r, o, s, t) {
                  ...
                  return {
                      ...
                      show: function(t, e, n) {
                          ...
                          void 0 === e && (e = 0);
                          n = n ? "linear" : a;
                          return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), Gr(o, "itemin", {
                              percent: e,
                              duration: t,
                              timing: n,
                              dir: s
                      ...
                      translate: function(t) {
                          this.reset();
                          var e = i(t, s);
                          qe(o, e[1]), qe(r, e[0]), Gr(o, "itemtranslatein", {
                              percent: t,
                              dir: s
                          }), Gr(r, "itemtranslateout", {
                              percent: 1 - t,
                              dir: s
                          })
                      },
          ...
          events: [{
              ...
              handler: function(t, n) {
                  ...
                  void 0 === h && (h = {}), this.setItem(n, "<span uk-spinner></span>"), r && (a = {
                      ...
                      return i.setError(n)
                  }) : "video" === e || r.match(/\.(mp4|webm|ogv)($|\?)/i) ? (Zt(u = Jr("video", Y({
                      src: r,
                      poster: c,
                      controls: "",
                      playsinline: "",
                      ...
                      return i.setError(n)
                  })) : "iframe" === e || r.match(/\.(html|php)($|\?)/i) ? this.setItem(n, Jr("iframe", Y({
                      src: r,
                      frameborder: "0",
                      allowfullscreen: "",
                      class: "uk-lightbox-iframe"
                  }, h))) : (s = r.match(/\/\/(?:.*?youtube(-nocookie)?\..*?[?&]v=|youtu\.be\/)([\w-]{11})[&?]?(.*)?/)) ? this.setItem(n, Jr("iframe", Y({
                      ...
                      var e = t.response,
                          t = e.height,
                          e = e.width;
                      return i.setItem(n, Jr("iframe", Y({
  ...
  Qi = {
      ...
      methods: {
          show: function(t) {
              ...
              return _(t) && (e = Zr(t).source, t = x(i, function(t) {
                  t = t.source;
                  return e === t
  ...
  Zi = {
      ...
      connected: function() {
          ...
          Qe.start(qe(this.$el, this.startProps), ((t = {
              opacity: 1
              ...
              read: function(t) {
                  ...
                  this.matchMedia && (t.image || !this.covers || !this.bgProps.length || (e = qe(this.$el, "backgroundImage").replace(/^none|url\(["']?(.+?)["']?\)$/, "$1")) && ((n = new Image).src = e, (t.image = n).naturalWidth || (n.onload = function() {
                      ...
                      var e, n = h.props[t],
                          ...
                          s = c[n] - a[n];
                      s < i ? a[n] = c[n] + i - s : i < s && ((e = a[n] / mn(r, n, h.$el)) && (h.props[t].steps = o.map(function(t) {
                          return t - (s - i) / e
                      }))), c = nt.cover(u, a)
                  }), t.dim = c))
              },
      ...
      update: {
          read: function(t, e) {
              ...
              if (e.has("scroll") || (n = !1), this.matchMedia) {
                  var i = n;
                  return t = qn(this.target) / (this.viewport || 1), e = this.easing, {
  ...
  er = {
          ...
          Transitioner: function(u, c, h, t) {
              ...
              return {
                  ...
                  show: function(t, e, n) {
                      void 0 === e && (e = 0);
                      n = n ? "linear" : r;
                      return t -= Math.round(t * Z(e, -1, 1)), this.translate(e), e = u ? e : Z(e, 0, 1), so(this.getItemIn(), "itemin", {
                          percent: e,
                          duration: t,
                          timing: n,
                          dir: h
                      }), u && so(this.getItemIn(!0), "itemout", {
                          percent: 1 - e,
                          duration: t,
                          timing: n,
                          dir: h
                      }), Qe.start(l, {
                          transform: qr(-d * (lt ? -1 : 1), "px")
                  ...
                  translate: function(r) {
                      ...
                      r = u ? Z(r, -1, 1) : 0, Pt(l).forEach(function(t) {
                          var e = w(o, t),
                              n = t === s,
                              i = t === a;
                          so(t, "itemtranslate" + (n || !i && (e || h * (lt ? -1 : 1) == -1 ^ ro(t, l) > ro(u || c)) ? "in" : "out"), {
                              dir: h,
      ...
      computed: {
          ...
          finite: function(t) {
              return t.finite || Math.ceil(io(this.list)) < sn(this.list).width + (t = this.list, Math.max.apply(Math, [0].concat(Pt(t).map(function(t) {
                  return sn(t).width
              })))) + this.center
          },
          maxIndex: function() {
          ...
          sets: function(t) {
              ...
              if (t = t.sets) {
                  ...
                  return !B(t = K(this.slides, "offsetLeft").reduce(function(t, e, n) {
                      var i = sn(e).width;
                      return s < u + i && (w(t, n = !r.center && n > r.maxIndex ? r.maxIndex : n) || (e = r.slides[n + 1], r.center && e && i < a - sn(e).width / 2 ? a -= i : (a = o, t.push(n), s = u + o + (r.center ? i / 2 : 0)))), u += i, t
                  }, [])) && t
              }
          },
          transitionOptions: function() {
          ...
          update: {
              read: function() {
                  ...
                  return this.minHeight && (t = Math.max(this.minHeight, t)), {
                      height: (t = this.maxHeight ? Math.min(this.maxHeight, t) : t) - fn(this.list, "height", "content-box")
                  }
              },
              write: function(t) {
                  t = t.height;
          ...
          update: {
              write: function(t) {
                  ...
                  this.drag && Ct(this.placeholder) && (e = (n = this.pos).x, a = n.y, s = (i = this.origin).offsetTop, r = i.offsetLeft, n = this.placeholder, qe(this.drag, {
                      top: a - s,
                      left: e - r
                  }), (i = this.getSortable(document.elementFromPoint(e, a))) && ((s = i.items).some(Qe.inProgress) || (o = {
                      x: e,
                      y: a
                  }, r = s[x(s, function(t) {
                      ...
                      if (Pt(t).length) {
                          ...
                          o = n.getBoundingClientRect(), t = ho([s.top, s.bottom], [o.top, o.bottom]), n = t ? i : r, i = t ? "width" : "height", r = t ? "left" : "top", t = t ? "right" : "bottom", i = o[i] < s[i] ? s[i] - o[i] : 0;
          ...
          methods: {
              ...
              start: function(t) {
                  this.drag = function(t, e) {
                      ...
                      }, qe(e, ["paddingLeft", "paddingRight", "paddingTop", "paddingBottom"]))), hn(t.firstElementChild, hn(e.firstElementChild)), t
                  ...
                  }), Be(this.drag, this.clsDrag, this.clsCustom), Be(this.placeholder, this.clsPlaceholder), Be(this.items, this.clsItem), Be(document.documentElement, this.clsDragState), ee(this.$el, "start", [this, this.placeholder]), e = this.pos, n = Date.now(), co = setInterval(function() {
                      var t = e.x,
                          s = e.y;
                      s += window.pageYOffset;
                      var a = .3 * (Date.now() - n);
                      n = Date.now(), Un(document.elementFromPoint(t, e.y)).reverse().some(function(t) {
                          var e = t.scrollTop,
                              n = t.scrollHeight,
                              i = an(Yn(t)),
                              r = i.top,
