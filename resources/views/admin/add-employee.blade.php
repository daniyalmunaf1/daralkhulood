     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storeemployee') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Add Employee</h3>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control item" value="{{ old('designation') }}" id="designation" name="designation" placeholder="Designation">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                            ...
                            <input type="text" class="form-control item" value="{{ old('facebook')}}" id="accnum" name="facebook" placeholder="facebook Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Instagram Link</label>
                            <input type="text" class="form-control item" value="{{ old('instagram')}}" id="accnum" name="instagram" placeholder="Instagram Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Twitter Link</label>
                            <input type="text" class="form-control item" value="{{ old('twitter')}}" id="accnum" name="twitter" placeholder="Twitter Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Linkedin Link</label>
                            <input type="text" class="form-control item" value="{{ old('linkedin')}}" id="accnum" name="linkedin" placeholder="Linkedin Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Youtube Link</label>
                            <input type="text" class="form-control item" value="{{ old('youtube')}}" id="accnum" name="youtube" placeholder="Youtube Link">
                        </div>
