     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storesliderimage') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Add Slider Image</h3>
                    </div>
                    
                    <div class="form-group">
                        <label for="username">Image</label>
                        <input type="file" class="form-control item" style="height:52px;" value="{{ old('name') }}" id="name" name="name" placeholder="Enter Image">
                    </div>
                    <div class="form-group">
