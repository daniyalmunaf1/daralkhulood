     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storeproject') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Add Project</h3>
                    </div>
                    
                    <div class="form-group">
                        <label for="username">Title</label>
                        <input type="text" class="form-control item" value="{{ old('title') }}" id="title" name="title" placeholder="Enter Title Of Project">
                    </div>
                    <div class="form-group">
