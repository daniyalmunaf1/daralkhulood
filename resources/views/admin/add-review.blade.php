     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storereview') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Add Review</h3>
                    </div>
                    <div class="form-group">
                        <label for="username">Customer Name</label>
                        <input type="text" class="form-control item" value="{{ old('name') }}" id="name" name="name" placeholder="Enter Customer name">
                    </div>
                    <div class="form-group">
                        <label for="username">Customer Type</label>
                        <input type="text" class="form-control item" value="{{ old('c_type') }}" id="name" name="CustomerType" placeholder="Enter Customer Type">
                    </div>
                    <div class="form-group">
                        <label for="username">Title</label>
                        <input type="text" class="form-control item" value="{{ old('title') }}" id="title" name="title" placeholder="Enter Title Of Review">
                    </div>
                    <div class="form-group">
