     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storeequipment') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Add Equipment</h3>
                    </div>
                    
                    <div class="form-group">
                        <label for="username">Title</label>
                        <input type="text" class="form-control item" value="{{ old('title') }}" id="title" name="title" placeholder="Enter Title Of Equipment">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="file"  style="height:52px;" class="form-control item" id="accnum" name="logo">
                    </div>
                    <div class="form-group">
