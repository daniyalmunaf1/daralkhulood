     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form method="POST" action="{{ route('updatecertificate') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <input type="hidden" class="form-control item" value="{{ $certificate->id }}" id="id" name="id" placeholder="Enter Name Of New User">
                    
                    <div class="form-group">
                        <label for="username">Name</label>
                        <input type="text" class="form-control item" value="{{ $certificate->name }}" id="name" name="name" placeholder="Enter Name Of New User">
                    </div>
