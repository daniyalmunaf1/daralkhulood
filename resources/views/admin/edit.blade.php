     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form method="POST" action="{{ route('updateEmployee') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <input type="hidden" class="form-control item" value="{{ $employee->id }}" id="id" name="id" placeholder="Enter Name Of New User">
                    
                    <div class="form-group">
                        <label for="username">Name</label>
                        <input type="text" class="form-control item" value="{{ $employee->name }}" id="name" name="name" placeholder="Enter Name Of New User">
                    </div>
                    <div class="form-group">
                        <label for="username">Designation</label>
                        <input type="text" class="form-control item" value="{{ $employee->designation }}" id="designation" name="designation" placeholder="Designation">
                    </div>
                    <div class="form-group">
                            <label for="accnum">Facebook Link</label>
                            <input type="text" class="form-control item" value="{{ $employee->facebook}}" id="accnum" name="facebook" placeholder="facebook Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Instagram Link</label>
                            <input type="text" class="form-control item" value="{{ $employee->instagram}}" id="accnum" name="instagram" placeholder="Instagram Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Twitter Link</label>
                            <input type="text" class="form-control item" value="{{ $employee->twitter}}" id="accnum" name="twitter" placeholder="Twitter Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Linkedin Link</label>
                            <input type="text" class="form-control item" value="{{ $employee->linkedin}}" id="accnum" name="linkedin" placeholder="Linkedin Link">
                        </div>
                        <div class="form-group">
                            <label for="accnum">Youtube Link</label>
                            <input type="text" class="form-control item" value="{{ $employee->youtube}}" id="accnum" name="youtube" placeholder="Youtube Link">
                        </div>
