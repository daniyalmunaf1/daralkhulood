    ...
    @include('admin.sidebar')
     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <form enctype="multipart/form-data" method="POST" action="{{ route('changeimage') }}" class="w-100">
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Change Image</h3>
                    </div>
                    <input type="hidden" class="form-control item" value="{{ $id }}" id="id" name="id" placeholder="Enter Name Of New User">
                    <input type="hidden" class="form-control item" value="{{ $name }}" id="id" name="name" placeholder="Enter Name Of New User">
                    ...
                    <div class="form-group">
                        <button type="Submit" class="btn btn-block create-account">Change</button>
                    </div>
                </form>
            </div>
