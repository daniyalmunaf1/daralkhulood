     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form enctype="multipart/form-data" method="POST" action="{{ route('storevideo') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control item" value="{{ old('link') }}" id="name" name="link" placeholder="Enter Embeded Video Link">
                    </div>
                    <div class="form-group">
