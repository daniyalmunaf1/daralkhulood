...
<a href="{{route('add-equipment')}}" class="btn btn-primary">Add Equipment</a>
                   ...
                   <tbody>
                       ...
                       <tr>
                          ...
                          <td><img  style="height: 50px;width:50px;" src="{{asset('/storage/'.$equipment->image)}}" alt=""><a title="change image" href="{{route('image',['id'=>$equipment->id,'equipment'])}}"><i style="color: #1089ff;font-size:21px;margin-left:5px;" class="fa fa-edit"></i></a></td>
                           ...
                           <td>
                            <a class="btn btn-primary" style="" href="{{route('editequipment',$equipment->id)}}"><i class="fa fa-edit"></i></a>
                           <form method="POST" style="float:right;" action="{{ route('delete-equipment',$equipment->id) }}" class="" novalidate="novalidate" id="" >
															@csrf
