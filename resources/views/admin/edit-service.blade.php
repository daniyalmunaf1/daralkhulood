     ...
     <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="registration-form">
                ...
                <form method="POST" action="{{ route('updateservice') }}" class="form w-100" novalidate="novalidate" id="" >
                    @csrf
            ...
            @endif
                    ...
                    <h3 style="margin-bottom :25px;">Edit Service</h3>
                    </div>
                    <input type="hidden" class="form-control item" value="{{ $service->id }}" id="id" name="id" placeholder="Enter Name Of New User">
                    
                    <div class="form-group">
                        <label for="username">Title</label>
                        <input type="text" class="form-control item" value="{{ $service->title }}" id="name" name="title" placeholder="Enter Title of Service">
                    </div>
                    <div class="form-group">
                        <label for="username">SubTitle</label>
                        <input type="text" class="form-control item" value="{{ $service->subtitle }}" id="name" name="subtitle" placeholder="Enter SubTitle of Service">
                    </div>
                    <div class="form-group">
                        <label for="username">Description</label>
                        <textarea type="text" class="form-control item"  id="description" rows="6" name="description" placeholder="Description">{{$service->description}}</textarea>
                    </div>
